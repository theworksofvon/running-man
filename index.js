...
const smallTall = "./img/platformSmallTall.png";
...
let smallTallImage = createImage(smallTall);
  ...
  platforms = [
    new Platform({
      x:
        ...
        2 +
        platformImage.width -
        smallTallImage.width,
      y: 250,
      image: smallTallImage,
    }),
    new Platform({
      x: -1,
      y: 470,
...
function animate() {
  ...
  // Win condition
  if (scrollOffset > platformImage.width * 6 + 500 - 2) {
